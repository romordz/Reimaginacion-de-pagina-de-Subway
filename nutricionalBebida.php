...
<body>
    ...
    <div class="topcontainer mt-3">
      <p class="fs-1 m-0 pub-title text-center">Información nutricional de Bebidas</p>
    </div>
    <!--Contenido-->
    <?php
    ...
    // Consulta SQL para obtener los datos de los productos tipo Sandwich
