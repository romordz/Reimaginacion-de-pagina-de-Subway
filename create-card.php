        ...
        <div class="card bigger-card px-5 pb-2 m-auto">
            <form method="post" id="cardForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control custom-inputs text-center" style="font-size: 28px;"
                        maxlength="16" pattern="\d{16}" name="Numero" required>
                </div>
                <div class="mb-4 row">
                    <div class="col d-flex flex-column align-items-center">
                        <p class="fs-2 fw-bold text-center">Fecha de expiración</p>
                        <input class="form-control custom-inputs" style="width:70%; font-size: 28px;" type="text"
                            name="FechaExpiracion" pattern="^\d{2}/\d{2}$" maxlength="5" required>
                    </div>
                    <div class="col d-flex flex-column align-items-center">
                        <p class="fs-2 fw-bold text-center">CVV</p>
                        <input class="form-control custom-inputs" style="width:70%; font-size: 28px;" type="text"
                            name="CVV" maxlength="3" pattern="\d{3}" required>
                    </div>
                </div>
                <p style="color: red; background-color: #004123; font-weight:bold; border-radius:5px; font-size: 20px;"
                    id="Message"></p>
                <button type="submit" name="submit" class="btn btn-primary btn-lg mb-3"
                    style="background-color: #e9cf3e; color: black; font-weight: bold; border: none; font-size: 28px;">
                    Continuar
                </button>
            </form>
        </div>
